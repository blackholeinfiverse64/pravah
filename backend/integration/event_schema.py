...
class StandardEvent:
    ...
    @classmethod
    def from_healing(
        cls, env: str, status: str, latency: float, strategy: str = "unknown"
    ) -> "StandardEvent":
    ...
    @classmethod
    def from_issue(cls, env: str, failure_type: str, reason: str = "") -> "StandardEvent":
    ...
    @classmethod
    def from_metric(
        cls, env: str, metric_type: str, metric_data: Dict[str, Any]
    ) -> "StandardEvent":
        """Create metric event."""
        return cls(
